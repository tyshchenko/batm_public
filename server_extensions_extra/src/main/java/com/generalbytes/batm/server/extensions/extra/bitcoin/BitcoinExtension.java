...
public class BitcoinExtension extends AbstractExtension{
    ...
    private static final CryptoCurrencyDefinition BTC_CRYPTOCURRENCY_DEFINITION = new BtcDefinition();
    ...
    public IExchange createExchange(String paramString) //(Bitstamp is in built-in extension)
    {
        if ((paramString != null) && (!paramString.trim().isEmpty())) {
            ...
            } else if ("valrexchange".equalsIgnoreCase(prefix)) {
                String apiKey = paramTokenizer.nextToken();
                String apiSecret = paramTokenizer.nextToken();
                String typeorder = paramTokenizer.nextToken();
                String preferredFiatCurrency = FiatCurrency.ZAR.getCode();
    ...
    public Set<ICryptoCurrencyDefinition> getCryptoCurrencyDefinitions() {
        ...
        result.add(BTC_CRYPTOCURRENCY_DEFINITION);
